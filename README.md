...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-maintenance-inventory?sort=semver)](https://github.com/liberusoftware/module-maintenance-inventory/releases/latest) [![Tests](https://github.com/liberusoftware/module-maintenance-inventory/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-maintenance-inventory/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-maintenance-inventory
```
...
<a href="https://github.com/liberusoftware/module-maintenance-inventory/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-maintenance-inventory" alt="Contributors to liberusoftware/module-maintenance-inventory">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-maintenance-inventory/graphs/contributors).
